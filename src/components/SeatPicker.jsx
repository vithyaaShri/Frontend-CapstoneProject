...
const SeatPicker = () => {
	...
	return (
		<div className='ss d-flex justify-content-center bg-secondary'>
			<div className='row'>
				<div className='column1'>
					<div className='plane center_div'>
						<form onChange={(e) => getSeatNumber(e)} className='justify-content-center'>
						...
						<div class="row">
                        <button className='btn btn-success center'onClick={handleBooking}>CONTINUE</button></div></div>
					</div>
				</div>
